...
class PlanControllerTest {
    ...
    void setUp() {
        ...
        activeDTO = new PlanResponseDTO(
                planId, "Gold", "Gold plan", 99.99, 30, "ACTIVE", new java.util.ArrayList<>(), new java.util.ArrayList<>()
        );
        inactiveDTO = new PlanResponseDTO(
                UUID.randomUUID(), "Basic", "Basic plan", 0.0, Integer.MAX_VALUE, "INACTIVE", new java.util.ArrayList<>(), new java.util.ArrayList<>()
        );
    }
