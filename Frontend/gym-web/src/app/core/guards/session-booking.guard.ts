...
export const sessionBookingGuard: CanActivateFn = (_route: ActivatedRouteSnapshot, state: RouterStateSnapshot) => {
  ...
  return entitlementsService.load().pipe(
    map(entitlements => entitlements.sessionBookingAllowed
      ? true
